...
export async function generate(input: string) {
    ...
    (async () => {
        const { textStream } = await streamText({
            ...
            Strictly ensure that your response is a completion of the input provided.
            ...
            Your output is directly concatenated to the input, so ensure that you do not add the input or any new lines or formatting, just plain text.
            `,
        });
